        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-300 lg:mx-auto">
              ...
              organization efficiently, from employee onboarding to performance
              tracking.
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 pr-4">
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  The Organization Management module in Synerga Apexion operates
                  as a central hub for all your HR and employee management
                  needs. It seamlessly integrates with the project management
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  By centralizing these functions, Synerga Apexion enables your
